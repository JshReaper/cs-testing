...
namespace Game1
{
    class Player : Component,IUpdateAble,ILoadable,IAnimateable,ICollisionStay,ICollisionExit,ICollisionEnter
    {
        ...
        private IStrategy playerBehavior;
        ...
        {
            animator.CreateAnimation("IdleFront", new Animation(1, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("IdleBack", new Animation(1, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("IdleLeft", new Animation(1, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("IdleRight", new Animation(1, 0, 0, 32, 32, 5, Vector2.Zero));
            ...
            animator.CreateAnimation("AttackFront", new Animation(3, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("AttackBack", new Animation(3, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("AttackRight", new Animation(3, 0, 0, 32, 32, 5, Vector2.Zero));
            animator.CreateAnimation("AttackLeft", new Animation(3, 0, 0, 32, 32, 5, Vector2.Zero));
